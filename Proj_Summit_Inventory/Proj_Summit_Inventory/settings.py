"""
Django settings for Proj_Summit_Inventory project.
...
SECRET_KEY = 'django-insecure-$1$@6#66%x08pvv(kdr1zdj0tkky1&5ff_r2%=0on^p3feoj%^'
...
WSGI_APPLICATION = 'Proj_Summit_Inventory.wsgi.application'
